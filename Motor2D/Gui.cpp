...
void Image::Draw()
{
	if (section.w>0 && section.h>0)
		App->render->Blit(texture, false, pos.first, pos.second, &section);
	else App->render->Blit(texture, false, pos.first, pos.second);
}
...
void Label::Draw()
{
	...
	App->render->Blit(texture,false,  pos.first, pos.second, &text_size);
}
